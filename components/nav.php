   ...
   <div class="header-logo">
    ...
    <div class="profile-wrapper">
        ...
        <button class="btn register">
            <a href="components/register.php">register</a>
        </button>
    </div> 
...
<nav>
    <div class="profile-wrapper-sm" id="profile-wrapper-sm">
    ...
    <div class="profile-name-sm">
        <span>Kweku Aikins</span>        
    </div>
    <div class="profile-btns-sm">
        <div class="btn">
        logout
        </div>
        <div class="btn">
